    ...
    <div class="hero-body">
        <div class="container has-text-centered">
            <div class="column is-4 is-offset-4">
                ...
                <div class="box">
                    <p class="is-danger help" v-if="error" v-text="error"></p>
                    <form action="#" @submit.prevent="register">
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <input class="input is-large" v-validate="'required|min:8|max:32'" :class="{'is-danger' : errors.has('password')}" name="password" v-model="form.password" type="password" placeholder="Password">
                            </div>
...
export default {
    ...
    methods : { 
        ...
        async register() {
            try {
                let response = this.registerUser(this.form)
            } catch(e) {
